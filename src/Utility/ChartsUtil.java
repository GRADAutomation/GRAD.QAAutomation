...
public class ChartsUtil extends DriverScript {
    ...
    public ChartsUtil (final WebDriver driver, final WebElement chart) {
    ...
    protected Color getSeriesColorAtXAxisPosition(int series, String xAxisLabelValue) {
        ...
        return Color.fromString(chart.findElement(By.cssSelector("//*[@id='highcharts-12']/svg/g[7]/g["+ 2 +"]/path")).getAttribute("fill"));
    }
    ...
    protected void hoverOverColumnOrBarChartSeriesAtXAxisPosition(int series, String xAxisLabel) {
        ...
        WebElement pointToHoverOver = chart.findElements(By.xpath("//*[@id='highcharts-12']/svg/g[7]/g[" +2+ "]/path")).get(barNumber);
